...
?>
    ...
    <form method="POST" action="index.php" enctype="multipart/form-data">
      ...
      <input type="text" class="form-control" id="exampleInputEmail1" name="name" required aria-describedby="emailHelp" style: width="375px"> <br><br>
      File : <input type="file" name="file"><br><br>
      <br/>
      <input type="submit" value="submit"  name= "submit">
    </form>

    <footer style="margin-left:-6%;margin-right:-6%; position:absolute; bottom:0; width:100%; ">
      <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-sm-4 col-md-3 col-lg-3 text-center">
                  ...
                  <div>
                      ...
                      <a href="https://www.facebook.com/KobyTuesday/">
